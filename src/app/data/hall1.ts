...
export const hall1Booths: Record<string, BoothInfo[]> = {
  A: [
    ...
    },
    {
      ...
      details: {
        region_name: "후쿠이현",
        history:
          "고쿠류주조는 1804년 창업한 후쿠이현의 전통 명가로, 에이헤이지 인근 지하수를 사용해 술을 빚습니다.",
        features:
          "지나치게 화려하지 않은 기품 있는 향과 실크처럼 매끄러운 목넘김.",
        official_site: "https://www.kokuryu.co.jp",
        type: "sake",
        tags: ["전통", "프리미엄"],
        flavor: "balance",
      },
    },
    {
      ...
      details: {
        region_name: "야마가타",
        history: "1892년 창업, 긴조슈 대중화의 선구자.",
        features: "사과·멜론을 떠올리게 하는 화사한 과실 향과 깨끗한 피니시.",
        official_site: "https://www.dewazakura.co.jp",
        type: "sake",
        tags: ["긴조", "과실향"],
        flavor: "amaguchi",
      },
    },
    {
      ...
      details: {
        region_name: "니가타",
        history: "니가타 탄레이 카라쿠치의 대명사.",
        features: "맑고 깨끗한 인상, 입안을 말끔하게 씻어주는 드라이한 식중주.",
        official_site: "https://www.koshinokanbai.co.jp",
        type: "sake",
        tags: ["드라이", "탄레이"],
        flavor: "karaguchi",
      },
    },
    {
      ...
      details: {
        region_name: "니가타",
        history: "전통 키모토 제조법으로 빚은 사케.",
        features: "모든 술을 키모토 제법으로 빚어 산미와 감칠맛이 살아있음.",
        official_site: "https://sugihime.jp",
        type: "sake",
        tags: ["키모토", "산미"],
        flavor: "karaguchi",
      },
    },
    {
      ...
      details: {
        region_name: "아키타",
        history: "2021년 설립된 혁신적 크래프트 사케 양조장.",
        features:
          "쌀을 기본으로 아가베, 홉 등 다양한 재료를 활용한 실험적 스타일.",
        official_site: "https://inetoagave.com",
        type: "other",
        tags: ["크래프트", "혁신"],
        flavor: "balance",
      },
    ...
    },
    {
      ...
      details: {
        region_name: "고치",
        history: "고치 식문화에 어울리는 깔끔한 사케 제작.",
        features: "단맛은 절제하고 선명한 산미와 드라이한 피니시 강조.",
        official_site: "https://suigei.jp",
        type: "sake",
        tags: ["드라이", "식중주"],
        flavor: "karaguchi",
      },
    },
    {
      ...
      details: {
        region_name: "홋카이도/사가",
        history: "홋카이도 최초의 양조장과 사가의 전통 명가의 만남.",
        features: "청량한 스타일과 묵직한 쌀맛의 대조가 특징.",
        official_site: "https://www.chitosetsuru.jp",
        type: "sake",
        tags: ["전통", "지역색"],
        flavor: "balance",
      },
    },
    {
      ...
      details: {
        region_name: "시즈오카",
        history: "시즈오카를 대표하는 고급 양조장.",
        features: "투명한 주질과 정교하고 화려한 향.",
        official_site: "",
        type: "sake",
        tags: ["프리미엄", "긴조"],
        flavor: "karaguchi",
    ...
    },
    {
      ...
      name: "우고노츠키/우타시로",
      details: {
        region_name: "히로시마/후쿠이",
        history: "부드러운 주질로 유명한 히로시마와 후쿠이의 브랜드.",
        features: "부드럽고 투명한 주질이 공통적인 특징.",
        official_site: "",
        type: "sake",
        tags: ["부드러움", "섬세함"],
        flavor: "amaguchi",
    ...
    },
    {
      ...
      details: {
        region_name: "오이타",
        history: "보리 소주를 전문으로 다뤄온 전통 증류 명가.",
        features: "볶은 보리 특유의 고소하고 스모키한 향이 일품.",
        official_site: "",
        type: "shochu",
        tags: ["보리소주", "고소함"],
        flavor: "karaguchi",
  ...
  B: [
    {
      id: "B03",
      name: "이마니시/카모니시키/토요비진/센킨/오니비/사츠마시마비진/아오카게/고다이우메슈",
      details: {
        region_name: "혼합",
        history: "모던 사케와 명품 소주들의 집합.",
        features: "현대적 감각의 사케부터 진한 고구마 소주까지.",
        official_site: "",
        type: "other",
        tags: ["모던", "쇼츄"],
        flavor: "balance",
    ...
    },
    {
      ...
      details: {
        region_name: "오키나와",
        history: "아와모리 대중화의 상징.",
        features: "부드럽고 깔끔한 아와모리, 입문자도 즐기기 좋음.",
        official_site: "",
        type: "awamori",
        flavor: "karaguchi",
      },
    },
    {
      ...
      details: {
        region_name: "후쿠이",
        history: "장기 저온 숙성 전문 명가.",
        features: "빙온 숙성을 통한 농밀한 감칠맛과 중후함.",
        official_site: "",
        type: "sake",
        flavor: "balance",
      },
    ...
    },
    {
      ...
      details: {
        region_name: "기획부스",
        history:
          "기존 소주·리큐르 문화를 ‘탄산과 섞어 마시는 스타일’로 재해석하는 콘셉트 부스입니다.",
        features:
          "소다와리 스타일 하이볼을 중심으로 청량감 있는 조합을 제안합니다.",
        official_site: "",
        type: "other",
        tags: ["하이볼", "청량감", "믹솔로지"],
      },
    },
    {
      ...
      details: {
        region_name: "기획/유통",
        history:
          "후쿠오카 기반의 주류 기획 브랜드로, 여러 양조장과 협업해 다양한 술을 소개합니다.",
        features:
          "큐슈 지역의 숨은 명주와 개성 강한 소주·리큐르를 선별해 소개하는 편집숍 콘셉트입니다.",
        official_site: "",
        type: "other",
        tags: ["편집숍", "큐레이션", "큐슈"],
        products: [
          {
            ...
            abv: "9%",
            description:
              "진하고 달콤한 풍미가 가득한 메로메로 모지코 바나나. 자연 그대로의 부드러운 식감과 깊은 바나나 향이 특징입니다. 모지코의 기후에서 자라 더욱 향긋하고 풍미가 뛰어납니다. 디저트와 음료에 잘 어울리며, 한 번 맛보면 잊기 어려운 매력을 지닙니다.",
          },
          {
            image: "/사케노이치자/2.jpg",
            name: "메로메로 홋카이도 멜론",
            abv: "8%",
            description:
              "향긋한 달콤함과 깊은 풍미를 담은 홋카이도 멜론. 신선한 멜론의 진한 단맛과 부드러운 식감이 입안을 가득 채웁니다. 홋카이도의 자연 환경에서 자라 뛰어난 품질과 향을 자랑합니다. 달콤하면서도 깔끔한 마무리로 누구나 즐기기 좋은 맛입니다.",
          },
          {
            image: "/사케노이치자/3.jpg",
            ...
            abv: "8%",
            description:
              "신비롭고 매혹적인 카시스 리큐르의 깊은 풍미. 검은 빛의 진한 색감과 블랙커런트의 풍부한 향이 특징입니다. 달콤함과 산미가 균형을 이루며 깊은 여운을 남깁니다. 디저트와 칵테일에 잘 어울리는 세련된 리큐르입니다.",
          },
          {
            image: "/사케노이치자/4.jpg",
            ...
            abv: "8%",
            description:
              "새콤달콤한 붉은 과일의 매력을 담은 카시스 리큐르. 부드러운 단맛과 상큼한 산미가 조화롭게 어우러집니다. 다채로운 과일 향과 상쾌한 맛이 특징입니다. 디저트와 칵테일에 잘 어울리는 매력적인 리큐르입니다.",
          },
        ],
      },
    },
    {
      ...
      details: {
        region_name: "후쿠오카",
        history: "슬램덩크 정대만 사케로 유명한 드라이 사케의 명가.",
        features: "깔끔하면서도 선명한 맛, 드라이한 설계가 특징.",
        official_site: "",
        type: "sake",
        flavor: "karaguchi",
        products: [
          {
            ...
            abv: "15.3%",
            description:
              "슬램덩크사케를 만드는 양조장에서 환상의 주조미인 '아이야마(愛山)'를 사용한 쥰마이다이긴죠입니다. 안정된 과일향, 입에 머금으면 촉촉히 퍼지는 쌀의 단 맛과 감칠 맛이 퍼집니다. '아이야마'다운 깊이 있는 맛이 특징이고, 끝 맛은 깨끗한 산미가 긴 여운을 연출하는 최고의 사케입니다.",
          },
          {
            image: "/미이노고토부키/2.jpg",
            ...
            abv: "15%",
            description:
              "쥬욘다이(十四代)가 18년에 걸쳐서 개발한 주조미 '사케미라이(酒未来)' 부드럽게 퍼져나가는 과일향, 매끄럽게 넘어가는 목넘김이 특징이며, 일본주도가 -4이지만, 마신 뒤 잡미가 남지 않아 산뜻하고 깨끗한 보디감을 선사하는 사케입니다.",
          },
          {
            image: "/미이노고토부키/3.jpg",
            ...
            abv: "14%",
            description:
              "높은 일본주도(+14)에도 불구하고, 야마다니시키의 풍부한 감칠맛과 9호 효모의 부드러운 향이 조화를 이루어, 깔끔하면서도 깊은 맛을 제공합니다. 산도와 아미노산도의 균형이 잘 맞아, 드라이한 맛을 선호하는 분들에게 특히 추천됩니다.",
          },
          {
            image: "/미이노고토부키/4.jpg",
            ...
            abv: "15.4%",
            description:
              "미이노고토부키가 와인 효모를 사용하여 만든 새로운 스타일의 쥰마이긴죠입니다. 화이트 와인을 방불케 하는 향과 산미의 볼륨감이 좋고, 살구 같은 과일향 외에도 다시국물 같은 뉘앙스와 카카오의 향도 느껴지는 여러 맛을 느낄 수 있는 사케입니다.",
          },
        ],
      },
    },
    {
      ...
      details: {
        region_name: "고치",
        history: "고치 식문화와 함께 성장한 명가.",
        features: "고치 식문화와 함께 성장한 명가.",
        official_site: "",
        type: "sake",
        flavor: "karaguchi",
        products: [
          {
            ...
            abv: "15%",
            description:
              "2013년 JAL(일본항공)국제선 FIRST CLASS사케. 철저한 품질관리하에서 술을 짠 후, 병주입하여 빙칸살균한 후, -１℃에서 출하까지 빙온저장. 화려한 향기와 산뜻한 감귤계의 산미, 깨끗한 목 넘김, 입 속에서 아련히 퍼지는 단 맛과 끝 맛의 조화가 좋습니다.",
          },
          {
            image: "/비죠후/2.jpg",
            name: "비죠후 쥰마이다이긴죠 마이",
            abv: "15%",
            description:
              "2021년 「JAL국제선 비즈니스 클래스 탑재 사케」 잔잔한 향기와 고급스러운 산미, 끝 맛이 좋은 식중 쥰마이다이긴조로, 10℃ 정도에서 풍부하면서 후레쉬한 신미가 식욕을 자극합니다.",
          },
          {
            image: "/비죠후/3.jpg",
            name: "비죠후 쥰마이긴죠 셀24",
            abv: "14%",
            description:
              "코치현이 개발한 특수 효모 ‘CEL24’를 사용하여 탄생한 개성 넘치는 프리미엄 사케입니다. CEL24 효모 특유의 화사하고 열대과일을 연상시키는 아로마(파인애플, 멜론 계열)가 인상적이며, 입안에서는 부드럽고 산뜻한 단맛과 산미가 균형 있게 어우러집니다. 기존의 드라이한 코치 스타일과는 차별화된, 보다 향기롭고 현대적인 스타일의 쥰마이긴죠입니다. *원료미:토사우라라(土佐麗)",
          },
          {
            image: "/비죠후/4.jpg",
            name: "비죠후 폰 슈와",
            abv: "6%",
            description:
              "톡톡 터지는 고치 감귤 퐁캉의 발포성 리큐어. 향기롭고 독특한 단맛과 감칠맛이 나는 퐁캉의 신선한 과즙을 듬뿍 사용했습니다. 상쾌하고 기분 좋은 탄산으로, 자연미 넘치는 상쾌한 풍미를 느껴보세요.",
          },
        ],
      },
    },
    {
      ...
      details: {
        region_name: "리큐르",
        history: "젊은 층을 타깃으로 한 디자인·맛 중심의 모던 브랜드입니다.",
        features:
          "달콤·산뜻한 풍미의 리큐르가 많으며, 칵테일 베이스로도 훌륭합니다.",
        official_site: "",
        type: "liqueur",
        tags: ["모던", "트렌디", "칵테일"],
        products: [
          {
            ...
            abv: "15%",
            description:
              "사라 sara 준마이긴조는 사라시리즈의 스테디셀러 사케로 나마즈메 타입의 술이지만 후레쉬한 느낌이 있고, 머스캣을 연상시키는 향과 쌀의 단맛이 입안에 퍼집니다. 그리고 피니쉬는 산미가 기분을 좋게하는 투명감 있는 맛입니다. 세련된 밸런스를 가지고 있어서, 여러 다양한 요리와도 매칭이 좋은 식중주타입의 사케입니다. 기품 있는 과일향, 쌀의 단맛·고급스러운 산미의 채색이 만들어내는 하모니를 즐겨보세요.",
          },
          {
            image: "/사라/2.jpg",
            ...
            abv: "15%",
            description:
              "본격적인 봄의 시작을 알리는 사라의 봄 한정 시리즈 <카스미>입니다. 사라의 특기인 '우스니고리'타입으로 출시되어 약간의 쌀 앙금을 머금고 기존의 버전보다 생동감 있는 감칠맛을 느낄 수 있습니다. 딸기와 라즈베리의 쥬시한 맛이 반기듯 입 안에서 퍼져나가며 과즙 같은 달콤함과 은은한 발포감 또한 느껴지는 시보리타테 나마자케로 사라의 특징인 부드러운 산미 또한 끝맛에서 깔끔하게 느끼실 수 있습니다. 벚꽃잎이 흩날리는 계절에 딱 어울리는 맛입니다.",
          },
          {
            image: "/사라/3.jpg",
            name: "사라 에스즈 나마즈메",
          ...
          },
          {
            ...
            abv: "16%",
            description:
              "사라가 와인 효모를 사용하여 만든 새로운 스타일의 쥰마이긴죠입니다. 화이트 와인을 방불케 하는 향과 산미의 볼륨감이 좋고, 살구 같은 과일향 외에도 다시국물 같은 뉘앙스와 카카오의 향도 느껴지는 여러 맛을 느낄 수 있는 사케입니다.",
          },
        ],
      },
    },
    {
      ...
      details: {
        region_name: "미에",
        history: "지역 밀착형 소규모 양조장.",
        features: "은은한 꽃향과 부드러운 단맛의 편안한 사케.",
        official_site: "",
        type: "sake",
        flavor: "amaguchi",
      },
  ...
  D: [
    {
      ...
      details: {
        region_name: "효고",
        history: "1505년 창업한 초장수 양조장.",
        features: "묵직한 클래식 스타일, 데워 마셔도 훌륭한 전통파.",
        official_site: "https://www.kenbishi.co.jp",
        type: "sake",
        flavor: "karaguchi",
        tags: ["니혼SAKE"],
        products: [
          {
            ...
            abv: "16%",
            description:
              "효고현산 야마다니시키와 아이야마 등을 풍부하게 사용하여 최저 1년이상 저장탱크에서 숙성시켜 깊은 맛과 부드러운 목넘김이 특징입니다.",
          },
          {
            image: "/겐비시/2.jpg",
            name: "고쿠죠 쿠로마츠 겐비시",
            abv: "15%",
            description:
              "입에 머금을 때 풍성한 맛을 느낄 수 있고 쌀의 감칠맛이 퍼져 마신 후의 깔끔함이 돋보이는 사케입니다.",
          },
          {
            image: "/겐비시/3.jpg",
            name: "미즈호 쿠로마츠 겐비시",
            abv: "17%",
            description:
              "적당한 산미와 쌀의 감칠맛에 은은하게 쓰고 떫은 맛을 띠고 있어 풍부하고 부드러운 맛을 느낄 수 있습니다. 또한 뒷맛의 여운도 매우 좋으며 깔끔합니다.",
          },
          {
            image: "/겐비시/4.jpg",
            name: "즈이쇼 쿠로마츠 겐비시",
            abv: "18%",
            description:
              "5년 이상에 걸쳐 장기 숙성한 다이코슈(大古酒)로, 농후한 향과 단맛이 화려하게 조화되어 있습니다. 입에 닿는 부드러운 느낌이 일품입니다.",
          },
        ],
      },
    },
