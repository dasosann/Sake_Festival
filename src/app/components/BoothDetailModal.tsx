                    ...
                    <div className="grid grid-cols-1 gap-4">
                      {selectedBooth.details.products.map((product, idx) => {
                        ...
                        return (
                          <div
                            key={idx}
                            className="bg-white border border-glass-border rounded-2xl overflow-hidden transition-all duration-300 hover:shadow-md hover:border-primary/20"
                          >
                            <div className="p-4 flex gap-4">
                              ...
                              <div className="flex-1 flex flex-col justify-between">
                                <div className="flex justify-between items-start mb-2">
                                  ...
                                  >
                                    <HeartIcon
                                      filled={favoriteProducts.includes(
                                        `${selectedBooth.id}_${idx}`,
                                      )}
                                      className="w-4 h-4"
                                    />
                                  </button>
